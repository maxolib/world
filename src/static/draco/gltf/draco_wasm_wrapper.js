...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.arrayIteratorImpl = function (f) { var m = 0; return function () { return m < f.length ? { done: !1, value: f[m++] } : { done: !0 }; }; };
$jscomp.arrayIterator = function (f) { return { next: $jscomp.arrayIteratorImpl(f) }; };
$jscomp.makeIterator = function (f) { var m = "undefined" != typeof Symbol && Symbol.iterator && f[Symbol.iterator]; return m ? m.call(f) : $jscomp.arrayIterator(f); };
$jscomp.getGlobal = function (f) { return "undefined" != typeof window && window === f ? f : "undefined" != typeof global && null != global ? global : f; };
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.ASSUME_ES5 = !1;
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (f, m, v) { f != Array.prototype && f != Object.prototype && (f[m] = v.value); };
$jscomp.polyfill = function (f, m, v, t) { if (m) {
    v = $jscomp.global;
    f = f.split(".");
...
$jscomp.polyfill("Promise", function (f) {
    function m() { this.batch_ = null; }
    function v(e) { return e instanceof h ? e : new h(function (l, f) { l(e); }); }
    if (f && !$jscomp.FORCE_POLYFILL_PROMISE)
        return f;
    m.prototype.asyncExecute = function (e) { if (null == this.batch_) {
        this.batch_ = [];
        var l = this;
        this.asyncExecuteFunction(function () { l.executeBatch_(); });
    } this.batch_.push(e); };
    var t = $jscomp.global.setTimeout;
    m.prototype.asyncExecuteFunction = function (e) { t(e, 0); };
    ...
    m.prototype.asyncThrow_ = function (e) { this.asyncExecuteFunction(function () { throw e; }); };
    var h = function (e) { this.state_ = 0; this.result_ = void 0; this.onSettledCallbacks_ = []; var l = this.createResolveAndReject_(); try {
    ...
    h.prototype.createResolveAndReject_ = function () {
        function e(e) { return function (h) { f || (f = !0, e.call(l, h)); }; }
        var l = this, f = !1;
        return { resolve: e(this.resolveTo_), reject: e(this.reject_) };
    };
    h.prototype.resolveTo_ = function (e) { if (e === this)
    ...
    h.prototype.reject_ = function (e) { this.settle_(2, e); };
    h.prototype.fulfill_ = function (e) { this.settle_(1, e); };
    h.prototype.settle_ = function (e, l) { if (0 != this.state_)
        throw Error("Cannot settle(" + e + ", " + l + "): Promise already settled in state" + this.state_); this.state_ = e; this.result_ = l; this.executeOnSettledCallbacks_(); };
    ...
    var X = new m;
    h.prototype.settleSameAsPromise_ = function (e) { var l = this.createResolveAndReject_(); e.callWhenSettled_(l.resolve, l.reject); };
    h.prototype.settleSameAsThenable_ = function (e, l) { var f = this.createResolveAndReject_(); try {
        e.call(l, f.resolve, f.reject);
    }
    catch (z) {
        f.reject(z);
    } };
    h.prototype.then = function (e, f) { function l(e, f) { return "function" == typeof e ? function (f) { try {
        m(e(f));
    }
    catch (p) {
        v(p);
    } } : f; } var m, v, t = new h(function (e, f) { m = e; v = f; }); this.callWhenSettled_(l(e, m), l(f, v)); return t; };
    h.prototype.catch = function (e) { return this.then(void 0, e); };
    h.prototype.callWhenSettled_ = function (e, f) { function l() { switch (h.state_) {
        case 1:
            e(h.result_);
            break;
        case 2:
            f(h.result_);
            break;
        default: throw Error("Unexpected state: " + h.state_);
    } } var h = this; null == this.onSettledCallbacks_ ? X.asyncExecute(l) : this.onSettledCallbacks_.push(l); };
    h.resolve = v;
    h.reject = function (e) { return new h(function (f, h) { h(e); }); };
    h.race = function (e) {
    ...
    h.all = function (e) { var f = $jscomp.makeIterator(e), m = f.next(); return m.done ? v([]) : new h(function (e, h) { function l(f) { return function (h) { t[f] = h; z--; 0 == z && e(t); }; } var t = [], z = 0; do
...
var DracoDecoderModule = function () {
    ...
    return function (m) {
        function v(k) { return a.locateFile ? a.locateFile(k, M) : M + k; }
        function t(a, c) { a || z("Assertion failed: " + c); }
        function h(a, c, b) {
            var d = c + b;
            for (b = c; a[b] && !(b >= d);)
                ++b;
            if (16 < b - c && a.subarray && xa)
        ...
        function X(a, c) { return a ? h(ca, a, c) : ""; }
        function e(a, c) { 0 < a % c && (a += c - a % c); return a; }
        function l(k) {
            ka = k;
        ...
        function z(k) { if (a.onAbort)
            a.onAbort(k); k += ""; ya(k); Y(k); za = !0; throw new WebAssembly.RuntimeError("abort(" + k + "). Build with -s ASSERTIONS=1 for more info."); }
        function va(a) {
        ...
        function Ma() { return da || !ea && !Z || "function" !== typeof fetch ? new Promise(function (a, c) { a(wa()); }) : fetch(U, { credentials: "same-origin" }).then(function (a) { if (!a.ok)
            throw "failed to load wasm binary file at '" + U + "'"; return a.arrayBuffer(); }).catch(function () { return wa(); }); }
        function ba() {
            if (!ba.strings) {
                var a = { USER: "web_user",
        ...
        function ma(k) {
            ...
            if (!(0 < aa)) {
                ...
                S(Fa);
                0 < aa || (a.setStatus ? (a.setStatus("Running..."), setTimeout(function () { setTimeout(function () { a.setStatus(""); }, 1); c(); }, 1)) : c());
            }
        }
        function p() { }
        function u(a) { return (a || p).__cache__; }
        function N(a, c) { var b = u(c), d = b[a]; if (d)
            return d; d = Object.create((c || p).prototype); d.ptr = a; return b[a] = d; }
        function V(a) {
            if ("string" === typeof a) {
        ...
        function x() { throw "cannot construct a Status, no constructor in IDL"; }
        function A() { this.ptr = Oa(); u(A)[this.ptr] = this; }
        function B() { this.ptr = Pa(); u(B)[this.ptr] = this; }
        function C() { this.ptr = Qa(); u(C)[this.ptr] = this; }
        function D() { this.ptr = Ra(); u(D)[this.ptr] = this; }
        function E() { this.ptr = Sa(); u(E)[this.ptr] = this; }
        function q() { this.ptr = Ta(); u(q)[this.ptr] = this; }
        function J() { this.ptr = Ua(); u(J)[this.ptr] = this; }
        function w() { this.ptr = Va(); u(w)[this.ptr] = this; }
        function F() {
            this.ptr =
                Wa();
            u(F)[this.ptr] = this;
        }
        function r() { this.ptr = Xa(); u(r)[this.ptr] = this; }
        function G() { this.ptr = Ya(); u(G)[this.ptr] = this; }
        function H() { this.ptr = Za(); u(H)[this.ptr] = this; }
        function O() { this.ptr = $a(); u(O)[this.ptr] = this; }
        function K() { this.ptr = ab(); u(K)[this.ptr] = this; }
        function g() { this.ptr = bb(); u(g)[this.ptr] = this; }
        function y() { this.ptr = cb(); u(y)[this.ptr] = this; }
        function Q() { throw "cannot construct a VoidPtr, no constructor in IDL"; }
        function I() { this.ptr = db(); u(I)[this.ptr] = this; }
        function L() {
            this.ptr = eb();
            u(L)[this.ptr] =
                this;
        ...
        a.onRuntimeInitialized = function () { Ga = !0; if (Ha && "function" === typeof a.onModuleLoaded)
            a.onModuleLoaded(a); };
        a.onModuleParsed = function () { Ha = !0; if (Ga && "function" === typeof a.onModuleLoaded)
            a.onModuleLoaded(a); };
        a.isVersionSupported = function (a) { if ("string" !== typeof a)
            return !1; a = a.split("."); return 2 > a.length || 3 < a.length ? !1 : 1 == a[0] && 0 <= a[1] && 3 >= a[1] ? !0 : 0 != a[0] || 10 < a[1] ? !1 : !0; };
        var ha = {}, W;
        for (W in a)
            a.hasOwnProperty(W) && (ha[W] = a[W]);
        var na = "./this.program", ea = !1, Z = !1, oa = !1, fb = !1, Ia = !1;
        ...
        if (oa) {
            M = __dirname + "/";
            var ra = function (a, c) { pa || (pa = require("fs")); qa || (qa = require("path")); a = qa.normalize(a); return pa.readFileSync(a, c ? null : "utf8"); };
            var la = function (a) { a = ra(a, !0); a.buffer || (a = new Uint8Array(a)); t(a.buffer); return a; };
            1 < process.argv.length &&
                (na = process.argv[1].replace(/\\/g, "/"));
            process.argv.slice(2);
            process.on("uncaughtException", function (a) { throw a; });
            process.on("unhandledRejection", z);
            a.inspect = function () { return "[Emscripten Module object]"; };
        }
        else if (Ia)
            "undefined" != typeof read && (ra = function (a) { return read(a); }), la = function (a) { if ("function" === typeof readbuffer)
                return new Uint8Array(readbuffer(a)); a = read(a, "binary"); t("object" === typeof a); return a; }, "undefined" !== typeof print && ("undefined" === typeof console && (console = {}), console.log = print,
                console.warn = console.error = "undefined" !== typeof printErr ? printErr : print);
        else if (ea || Z)
            Z ? M = self.location.href : document.currentScript && (M = document.currentScript.src), f && (M = f), M = 0 !== M.indexOf("blob:") ? M.substr(0, M.lastIndexOf("/") + 1) : "", ra = function (a) { var c = new XMLHttpRequest; c.open("GET", a, !1); c.send(null); return c.responseText; }, Z && (la = function (a) { var c = new XMLHttpRequest; c.open("GET", a, !1); c.responseType = "arraybuffer"; c.send(null); return new Uint8Array(c.response); });
        var ya = a.print || console.log.bind(console), Y = a.printErr || console.warn.bind(console);
        for (W in ha)
        ...
        var ia, gb = new WebAssembly.Table({ initial: 293, maximum: 293, element: "anyfunc" }), za = !1, xa = "undefined" !== typeof TextDecoder ? new TextDecoder("utf8") : void 0;
        ...
        var Aa = {}, R = { buffers: [null, [], []], printChar: function (a, c) { var b = R.buffers[a]; 0 === c || 10 === c ? ((1 === a ? ya : Y)(h(b, 0)), b.length = 0) : b.push(c); }, varargs: 0, get: function (a) { R.varargs += 4; return P[R.varargs - 4 >> 2]; }, getStr: function () { return X(R.get()); },
            get64: function () { var a = R.get(); R.get(); return a; }, getZero: function () { R.get(); } }, Ka = { __cxa_allocate_exception: function (a) { return ib(a); }, __cxa_throw: function (a, c, b) { "uncaught_exception" in ta ? ta.uncaught_exceptions++ : ta.uncaught_exceptions = 1; throw a; }, abort: function () { z(); }, emscripten_get_sbrk_ptr: function () { return 13664; }, emscripten_memcpy_big: function (a, c, b) { ca.set(ca.subarray(c, c + b), a); }, emscripten_resize_heap: function (a) {
                ...
                return b ? !0 : !1;
            }, environ_get: function (a, c) { var b = 0; ba().forEach(function (d, e) { var f = c + b; e = P[a + 4 * e >> 2] = f; for (f = 0; f < d.length; ++f)
                T[e++ >> 0] = d.charCodeAt(f); T[e >> 0] = 0; b += d.length + 1; }); return 0; }, environ_sizes_get: function (a, c) { var b = ba(); P[a >> 2] = b.length; var d = 0; b.forEach(function (a) { d += a.length + 1; }); P[c >> 2] = d; return 0; }, fd_close: function (a) { return 0; }, fd_seek: function (a, c, b, d, e) { return 0; }, fd_write: function (a, c, b, d) { try {
            ...
            } }, memory: ia, setTempRet0: function (a) { }, table: gb }, La = function () {
            function e(c, b) { a.asm = c.exports; aa--; a.monitorRunDependencies && a.monitorRunDependencies(aa); 0 == aa && (null !== sa && (clearInterval(sa), sa = null), ja && (c = ja, ja = null, c())); }
            function c(a) { e(a.instance); }
            function b(a) { return Ma().then(function (a) { return WebAssembly.instantiate(a, d); }).then(a, function (a) { Y("failed to asynchronously prepare wasm: " + a); z(a); }); }
            ...
            (function () {
                if (da || "function" !== typeof WebAssembly.instantiateStreaming || va(U) || "function" !== typeof fetch)
                    return b(c);
                fetch(U, { credentials: "same-origin" }).then(function (a) { return WebAssembly.instantiateStreaming(a, d).then(c, function (a) { Y("wasm streaming compile failed: " + a); Y("falling back to ArrayBuffer instantiation"); b(c); }); });
            })();
            return {};
        }();
        a.asm = La;
        var hb = a.___wasm_call_ctors = function () { return a.asm.__wasm_call_ctors.apply(null, arguments); }, jb = a._emscripten_bind_Status_code_0 = function () { return a.asm.emscripten_bind_Status_code_0.apply(null, arguments); }, kb = a._emscripten_bind_Status_ok_0 = function () {
        ...
        var ta = a.__ZSt18uncaught_exceptionv =
            function () { return a.asm._ZSt18uncaught_exceptionv.apply(null, arguments); };
        ...
        a.stackSave = function () { return a.asm.stackSave.apply(null, arguments); };
        a.stackAlloc = function () { return a.asm.stackAlloc.apply(null, arguments); };
        ...
        a.dynCall_iiii = function () { return a.asm.dynCall_iiii.apply(null, arguments); };
        a.dynCall_v = function () { return a.asm.dynCall_v.apply(null, arguments); };
        a.dynCall_viii = function () { return a.asm.dynCall_viii.apply(null, arguments); };
        a.dynCall_viiii = function () { return a.asm.dynCall_viiii.apply(null, arguments); };
        a.dynCall_iiiiiii = function () { return a.asm.dynCall_iiiiiii.apply(null, arguments); };
        a.dynCall_iidiiii = function () { return a.asm.dynCall_iidiiii.apply(null, arguments); };
        a.dynCall_jiji = function () { return a.asm.dynCall_jiji.apply(null, arguments); };
        a.dynCall_viiiiii = function () { return a.asm.dynCall_viiiiii.apply(null, arguments); };
        a.dynCall_viiiii = function () { return a.asm.dynCall_viiiii.apply(null, arguments); };
        a.asm = La;
        var fa;
        a.then = function (e) {
            if (fa)
                ...
                a.onRuntimeInitialized = function () { c && c(); e(a); };
            }
            return a;
        };
        ja = function c() { fa || ma(); fa || (ja = c); };
        a.run = ma;
        if (a.preInit)
        ...
        a.getCache = u;
        a.wrapPointer = N;
        a.castObject = function (a, b) { return N(a.ptr, b); };
        a.NULL = N(0);
        ...
        a.compare = function (a, b) { return a.ptr === b.ptr; };
        a.getPointer = function (a) { return a.ptr; };
        a.getClass = function (a) { return a.__class__; };
        var n = { buffer: 0, size: 0, pos: 0, temps: [], needed: 0, prepare: function () { if (n.needed) {
                for (var c = 0; c < n.temps.length; c++)
                    a._free(n.temps[c]);
                n.temps.length = 0;
                a._free(n.buffer);
                n.buffer = 0;
                n.size += n.needed;
                n.needed = 0;
            } n.buffer || (n.size += 128, n.buffer = a._malloc(n.size), t(n.buffer)); n.pos = 0; }, alloc: function (c, b) {
                t(n.buffer);
                c = c.length * b.BYTES_PER_ELEMENT;
                c = c + 7 & -8;
                n.pos + c >= n.size ? (t(0 < c), n.needed += c, b = a._malloc(c), n.temps.push(b)) : (b = n.buffer + n.pos, n.pos += c);
                return b;
            }, copy: function (a, b, d) { switch (b.BYTES_PER_ELEMENT) {
                case 2:
                    d >>= 1;
                    break;
                case 4:
        ...
        x.__cache__ = {};
        a.Status = x;
        x.prototype.code = x.prototype.code = function () { return jb(this.ptr); };
        x.prototype.ok = x.prototype.ok = function () { return !!kb(this.ptr); };
        x.prototype.error_msg =
            x.prototype.error_msg = function () { return X(lb(this.ptr)); };
        x.prototype.__destroy__ = x.prototype.__destroy__ = function () { mb(this.ptr); };
        A.prototype = Object.create(p.prototype);
        A.prototype.constructor = A;
        A.prototype.__class__ = A;
        A.__cache__ = {};
        a.DracoUInt16Array = A;
        A.prototype.GetValue = A.prototype.GetValue = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return nb(c, a); };
        A.prototype.size = A.prototype.size = function () { return ob(this.ptr); };
        A.prototype.__destroy__ = A.prototype.__destroy__ = function () { pb(this.ptr); };
        B.prototype = Object.create(p.prototype);
        B.prototype.constructor = B;
        B.prototype.__class__ = B;
        B.__cache__ = {};
        a.PointCloud = B;
        B.prototype.num_attributes = B.prototype.num_attributes = function () { return qb(this.ptr); };
        B.prototype.num_points = B.prototype.num_points = function () { return rb(this.ptr); };
        B.prototype.__destroy__ = B.prototype.__destroy__ = function () { sb(this.ptr); };
        ...
        C.prototype.GetValue =
            C.prototype.GetValue = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return tb(c, a); };
        C.prototype.size = C.prototype.size = function () { return ub(this.ptr); };
        C.prototype.__destroy__ = C.prototype.__destroy__ = function () { vb(this.ptr); };
        D.prototype = Object.create(p.prototype);
        D.prototype.constructor = D;
        D.prototype.__class__ = D;
        D.__cache__ = {};
        a.DracoUInt32Array = D;
        D.prototype.GetValue = D.prototype.GetValue = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return wb(c, a); };
        D.prototype.size = D.prototype.size =
            function () { return xb(this.ptr); };
        D.prototype.__destroy__ = D.prototype.__destroy__ = function () { yb(this.ptr); };
        E.prototype = Object.create(p.prototype);
        E.prototype.constructor = E;
        E.prototype.__class__ = E;
        E.__cache__ = {};
        a.AttributeOctahedronTransform = E;
        E.prototype.InitFromAttribute = E.prototype.InitFromAttribute = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return !!zb(c, a); };
        E.prototype.quantization_bits = E.prototype.quantization_bits = function () { return Ab(this.ptr); };
        E.prototype.__destroy__ = E.prototype.__destroy__ =
            function () { Bb(this.ptr); };
        q.prototype = Object.create(p.prototype);
        q.prototype.constructor = q;
        q.prototype.__class__ = q;
        q.__cache__ = {};
        a.PointAttribute = q;
        q.prototype.size = q.prototype.size = function () { return Cb(this.ptr); };
        q.prototype.GetAttributeTransformData = q.prototype.GetAttributeTransformData = function () { return N(Db(this.ptr), J); };
        q.prototype.attribute_type = q.prototype.attribute_type = function () { return Eb(this.ptr); };
        q.prototype.data_type = q.prototype.data_type = function () { return Fb(this.ptr); };
        q.prototype.num_components =
            q.prototype.num_components = function () { return Gb(this.ptr); };
        q.prototype.normalized = q.prototype.normalized = function () { return !!Hb(this.ptr); };
        q.prototype.byte_stride = q.prototype.byte_stride = function () { return Ib(this.ptr); };
        q.prototype.byte_offset = q.prototype.byte_offset = function () { return Jb(this.ptr); };
        q.prototype.unique_id = q.prototype.unique_id = function () { return Kb(this.ptr); };
        q.prototype.__destroy__ = q.prototype.__destroy__ = function () { Lb(this.ptr); };
        ...
        J.prototype.transform_type = J.prototype.transform_type = function () { return Mb(this.ptr); };
        J.prototype.__destroy__ = J.prototype.__destroy__ = function () { Nb(this.ptr); };
        w.prototype = Object.create(p.prototype);
        w.prototype.constructor = w;
        w.prototype.__class__ = w;
        w.__cache__ = {};
        a.AttributeQuantizationTransform = w;
        w.prototype.InitFromAttribute = w.prototype.InitFromAttribute = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return !!Ob(c, a); };
        w.prototype.quantization_bits = w.prototype.quantization_bits = function () { return Pb(this.ptr); };
        w.prototype.min_value = w.prototype.min_value = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return Qb(c, a); };
        w.prototype.range = w.prototype.range = function () { return Rb(this.ptr); };
        w.prototype.__destroy__ = w.prototype.__destroy__ = function () { Sb(this.ptr); };
        ...
        F.prototype.GetValue = F.prototype.GetValue =
            function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return Tb(c, a); };
        F.prototype.size = F.prototype.size = function () { return Ub(this.ptr); };
        F.prototype.__destroy__ = F.prototype.__destroy__ = function () { Vb(this.ptr); };
        ...
        r.prototype.GetIntEntry = r.prototype.GetIntEntry = function (a, b) { var c = this.ptr; n.prepare(); a && "object" === typeof a && (a = a.ptr); b = b && "object" === typeof b ? b.ptr : V(b); return Xb(c, a, b); };
        r.prototype.GetIntEntryArray = r.prototype.GetIntEntryArray = function (a, b, d) { var c = this.ptr; n.prepare(); a && "object" === typeof a && (a = a.ptr); b = b && "object" === typeof b ? b.ptr : V(b); d && "object" === typeof d && (d = d.ptr); Yb(c, a, b, d); };
        ...
        r.prototype.GetStringEntry = r.prototype.GetStringEntry = function (a, b) { var c = this.ptr; n.prepare(); a && "object" === typeof a && (a = a.ptr); b = b && "object" === typeof b ? b.ptr : V(b); return X($b(c, a, b)); };
        r.prototype.NumEntries = r.prototype.NumEntries = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return ac(c, a); };
        ...
        r.prototype.__destroy__ = r.prototype.__destroy__ = function () { cc(this.ptr); };
        G.prototype = Object.create(p.prototype);
        G.prototype.constructor = G;
        G.prototype.__class__ = G;
        G.__cache__ = {};
        a.DracoInt16Array = G;
        G.prototype.GetValue = G.prototype.GetValue = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return dc(c, a); };
        G.prototype.size = G.prototype.size = function () { return ec(this.ptr); };
        G.prototype.__destroy__ = G.prototype.__destroy__ = function () { fc(this.ptr); };
        H.prototype =
        ...
        H.prototype.GetValue = H.prototype.GetValue = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return gc(c, a); };
        H.prototype.size = H.prototype.size = function () { return hc(this.ptr); };
        H.prototype.__destroy__ = H.prototype.__destroy__ = function () { ic(this.ptr); };
        ...
        O.prototype.__destroy__ =
            O.prototype.__destroy__ = function () { jc(this.ptr); };
        K.prototype = Object.create(p.prototype);
        K.prototype.constructor = K;
        K.prototype.__class__ = K;
        K.__cache__ = {};
        a.DecoderBuffer = K;
        K.prototype.Init = K.prototype.Init = function (a, b) { var c = this.ptr; n.prepare(); if ("object" == typeof a && "object" === typeof a) {
            var e = n.alloc(a, T);
            n.copy(a, T, e);
            a = e;
        } b && "object" === typeof b && (b = b.ptr); kc(c, a, b); };
        K.prototype.__destroy__ = K.prototype.__destroy__ = function () { lc(this.ptr); };
        g.prototype = Object.create(p.prototype);
        ...
        g.__cache__ = {};
        a.Decoder = g;
        g.prototype.GetEncodedGeometryType = g.prototype.GetEncodedGeometryType = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return mc(c, a); };
        g.prototype.DecodeBufferToPointCloud = g.prototype.DecodeBufferToPointCloud = function (a, b) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); return N(nc(c, a, b), x); };
        ...
        g.prototype.GetAttributeId = g.prototype.GetAttributeId = function (a, b) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); return pc(c, a, b); };
        g.prototype.GetAttributeIdByName = g.prototype.GetAttributeIdByName = function (a, b) { var c = this.ptr; n.prepare(); a && "object" === typeof a && (a = a.ptr); b = b && "object" === typeof b ? b.ptr : V(b); return qc(c, a, b); };
        g.prototype.GetAttributeIdByMetadataEntry = g.prototype.GetAttributeIdByMetadataEntry =
            function (a, b, d) { var c = this.ptr; n.prepare(); a && "object" === typeof a && (a = a.ptr); b = b && "object" === typeof b ? b.ptr : V(b); d = d && "object" === typeof d ? d.ptr : V(d); return rc(c, a, b, d); };
        g.prototype.GetAttribute = g.prototype.GetAttribute = function (a, b) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); return N(sc(c, a, b), q); };
        ...
        g.prototype.GetMetadata = g.prototype.GetMetadata = function (a) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); return N(uc(c, a), L); };
        g.prototype.GetAttributeMetadata = g.prototype.GetAttributeMetadata = function (a, b) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); return N(vc(c, a, b), L); };
        ...
        g.prototype.GetTriangleStripsFromMesh = g.prototype.GetTriangleStripsFromMesh = function (a, b) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); return xc(c, a, b); };
        g.prototype.GetTrianglesUInt16Array = g.prototype.GetTrianglesUInt16Array = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!yc(c, a, b, d); };
        g.prototype.GetTrianglesUInt32Array = g.prototype.GetTrianglesUInt32Array =
            function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!zc(c, a, b, d); };
        g.prototype.GetAttributeFloat = g.prototype.GetAttributeFloat = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!Ac(c, a, b, d); };
        ...
        g.prototype.GetAttributeIntForAllPoints = g.prototype.GetAttributeIntForAllPoints = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!Cc(c, a, b, d); };
        ...
        g.prototype.GetAttributeUInt8ForAllPoints = g.prototype.GetAttributeUInt8ForAllPoints = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!Ec(c, a, b, d); };
        ...
        g.prototype.GetAttributeUInt16ForAllPoints = g.prototype.GetAttributeUInt16ForAllPoints = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!Gc(c, a, b, d); };
        ...
        g.prototype.GetAttributeUInt32ForAllPoints = g.prototype.GetAttributeUInt32ForAllPoints = function (a, b, d) { var c = this.ptr; a && "object" === typeof a && (a = a.ptr); b && "object" === typeof b && (b = b.ptr); d && "object" === typeof d && (d = d.ptr); return !!Ic(c, a, b, d); };
        ...
        g.prototype.SkipAttributeTransform = g.prototype.SkipAttributeTransform = function (a) { var b = this.ptr; a && "object" === typeof a && (a = a.ptr); Kc(b, a); };
        g.prototype.__destroy__ = g.prototype.__destroy__ = function () { Lc(this.ptr); };
        y.prototype = Object.create(p.prototype);
        y.prototype.constructor = y;
        y.prototype.__class__ = y;
        y.__cache__ = {};
        a.Mesh = y;
        y.prototype.num_faces = y.prototype.num_faces = function () { return Mc(this.ptr); };
        y.prototype.num_attributes = y.prototype.num_attributes =
            function () { return Nc(this.ptr); };
        y.prototype.num_points = y.prototype.num_points = function () { return Oc(this.ptr); };
        y.prototype.__destroy__ = y.prototype.__destroy__ = function () { Pc(this.ptr); };
        Q.prototype = Object.create(p.prototype);
        Q.prototype.constructor = Q;
        Q.prototype.__class__ = Q;
        Q.__cache__ = {};
        a.VoidPtr = Q;
        Q.prototype.__destroy__ = Q.prototype.__destroy__ = function () { Qc(this.ptr); };
        ...
        I.prototype.GetValue =
            I.prototype.GetValue = function (a) { var b = this.ptr; a && "object" === typeof a && (a = a.ptr); return Rc(b, a); };
        I.prototype.size = I.prototype.size = function () { return Sc(this.ptr); };
        I.prototype.__destroy__ = I.prototype.__destroy__ = function () { Tc(this.ptr); };
        L.prototype = Object.create(p.prototype);
        L.prototype.constructor = L;
        L.prototype.__class__ = L;
        L.__cache__ = {};
        a.Metadata = L;
        L.prototype.__destroy__ = L.prototype.__destroy__ = function () { Uc(this.ptr); };
        (function () {
            function c() {
                a.OK = Vc();
                a.DRACO_ERROR = Wc();
